...
public class RangerBasedAccessControlConfig
{
    ...
    public static final String RANGER_HIVE_POLICYMGR_SSL_PATH = "hive.ranger.policymgr-ssl.path";

    public static final String RANGER_REST_POLICY_MGR_DOWNLOAD_URL = "/service/plugins/secure/policies/download";
    ...
    private String rangerHivePolicymgrSslPath;
    ...
    public String getRangerHivePolicymgrSslPath()
    {
        return rangerHivePolicymgrSslPath;
    }

    @Config(RANGER_HIVE_POLICYMGR_SSL_PATH)
    public void setRangerHivePolicymgrSslPath(String rangerHivePolicymgrSslPath)
    {
        this.rangerHivePolicymgrSslPath = rangerHivePolicymgrSslPath;
    }
}
